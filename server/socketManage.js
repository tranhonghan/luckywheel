...
module.exports = io => socket => {
    ...
    socket.on( events.TYPE_WHEEL, ({ channel, data }) => {
        io.emit( events.TYPE_WHEEL, ({ channel, data }))
    })

    socket.on( events.RESULT_WHEEL, ({ channel, data }) => {
        io.emit( events.RESULT_WHEEL, ({ channel, data }))
    })
}
